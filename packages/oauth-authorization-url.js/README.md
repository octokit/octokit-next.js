...
[![@latest](https://img.shields.io/npm/v/@octokit-next/oauth-authorization-url.svg)](https://www.npmjs.com/package/@octokit-next/oauth-authorization-url)
[![Build Status](https://github.com/octokit-next/oauth-authorization-url.js/workflows/Test/badge.svg)](https://github.com/octokit-next/oauth-authorization-url.js/actions?query=workflow%3ATest+branch%3Amaster)
...
Load `@octokit-next/oauth-authorization-url` directly from [cdn.skypack.dev](https://cdn.skypack.dev)
...
Install with <code>npm install @octokit/oauth-next-authorization-url</code>
...
Load <code>@octokit-next/oauth-next-authorization-url</code> directly from <a href="https://cdn.skypack.dev">cdn.skypack.dev</a>, including types.
