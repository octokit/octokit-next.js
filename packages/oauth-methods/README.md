...
[![@latest](https://img.shields.io/npm/v/@octokit-next/oauth-methods.svg)](https://www.npmjs.com/package/@octokit-next/oauth-methods)
[![Build Status](https://github.com/octokit-next/oauth-methods.js/workflows/Test/badge.svg)](https://github.com/octokit-next/oauth-methods.js/actions?query=workflow%3ATest+branch%3Amaster)
...
`@octokit-next/oauth-methods` is not meant for browser usage.
...
Load <code>@octokit-next/oauth-methods</code> directly from <a href="https://cdn.skypack.dev">cdn.skypack.dev</a>, including types.
