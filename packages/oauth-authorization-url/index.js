...
oauthAuthorizationUrl.VERSION = VERSION;

/**
 * @param {import(".").OAuthAppOptions | import(".").GitHubAppOptions} options
  ...
  Object.keys(map)
    ...
    .filter((k) => {
      ...
      return (
        ...
        // @ts-expect-error - TS should know that options[k] is an array here
        options[k].length > 0
      );
    })
